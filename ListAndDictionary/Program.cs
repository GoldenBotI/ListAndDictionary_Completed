    ...
    internal class Program
    {
        ...
        public static void AddPerson()
        {
            ...
            if (personList.Contains(name) == true)
                Console.WriteLine("Sorry, requested name already exists in the List.");
            else
            {
                personList.Add(name);
                Console.WriteLine("The name was successfully added to the List!");
            }
            if (personAgeDictionary.ContainsKey(name) == true)
                Console.WriteLine("Sorry, requested name already exists in the Dictionary.");
            else
            {
                Console.Write("Please enter yout age here: ");
                int age = Convert.ToInt32(Console.ReadLine());
                personAgeDictionary.Add(name, age);
                Console.WriteLine("The name was successfuly added to the Dictionary!");
            }
        }
        ...
        public static void RemovePerson()
        {
            ...
            Console.Write("Please enter name to delete here: ");
            string name = Console.ReadLine();
            if (personList.Contains(name) == true)
            {
                personList.Remove(name);
                Console.WriteLine("The name was successfuly removed removed fron the List!");
            }
            else
                Console.WriteLine("Sorry, requested name does not exist in the List.");
            if (personAgeDictionary.ContainsKey(name) == true)
            {
                personAgeDictionary.Remove(name);
                Console.WriteLine("The name was successfuly removed removed fron the Dictionary!");
            }
            else
                Console.WriteLine("Sorry, requested name does not exist in the Dictionary.");
        }
        ...
        public static void FindPerson()
        {
            ...
            string name = Console.ReadLine();
            if (personList.Contains(name) == true)
                Console.WriteLine($"Requested name {name} was found in the List with index {personList.IndexOf(name)}.");
            else
                Console.WriteLine("Sorry, requested name does not exist in the List.");
            if (personAgeDictionary.ContainsKey(name) == true)
                Console.WriteLine($"Requested name {name} was found in the Dictionary.");
            else
                Console.WriteLine("Sorry, requested name does not exist in the Dictionary.");
